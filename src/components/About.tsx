        ...
        >
          <div className="relative">
            ...
            <div className="overflow-hidden rounded-3xl shadow-2xl">
              <img
                src="https://images.pexels.com/photos/5560763/pexels-photo-5560763.jpeg?auto=compress&cs=tinysrgb&w=700"
            ...
            <div className="absolute -bottom-5 -left-5 bg-white rounded-2xl shadow-xl p-4 flex items-center gap-3">
              ...
              <div>
                <p className="font-serif font-700 text-leaf-800 text-sm">100% Alami</p>
                <p className="font-sans text-leaf-600 text-xs">Tanpa bahan pengawet</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="font-sans text-gray-600 text-base leading-relaxed mb-4">
              ...
              terbuat dari beras ketan, dibentuk segitiga atau lonjong, lalu direbus
              hingga matang sempurna. Disajikan dengan siram gula merah cair yang
              legit dan taburan kelapa parut segar — setiap gigitan adalah perjalanan
              ke masa kecil yang hangat.
            </p>
            <p className="font-sans text-gray-600 text-base leading-relaxed mb-8">
              Di <strong className="text-leaf-700">Lupis Tiktik</strong>, kami menjaga
              tradisi ini tetap hidup dengan cara yang higienis dan modern. Setiap
              lupis dibuat dari bahan-bahan berkualitas pilihan: beras ketan premium,
              gula merah asli, dan kelapa segar tanpa pengawet — disiapkan dengan
              penuh cinta setiap harinya.
            </p>
